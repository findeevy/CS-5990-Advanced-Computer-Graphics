 ...
 * @brief Provides utility functions for Vulkan operations (file I/O and image view creation).
 *
...
namespace vkutils {
     ...
     *
     * @note Commonly used to load SPIR-V shader bytecode for Vulkan pipeline creation.
     *
     * @code
     ...
     * @param aspectFlags Specifies which aspects (color, depth, stencil) are included.
     ...
     *
     * @code
     * vk::raii::ImageView imageView = vkutils::createImageView(device, image, format,
